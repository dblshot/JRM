  ...
  return (
    <Box minHeight="100vh" bgcolor={DARK_BG} px={{ xs: 1, sm: 4 }} py={6}>
      ...
      <Grid container spacing={2} justifyContent="center" mb={4}>
        ...
        <Grid item>
          <Button
            variant={view === 'assignmentStatus' ? 'contained' : 'outlined'}
            size="large"
            sx={{
              minWidth: 180,
              fontWeight: 'bold',
              fontSize: 18,
              bgcolor: view === 'assignmentStatus' ? ORANGE : DARKER_BG,
              color: view === 'assignmentStatus' ? DARK_BG : ORANGE,
              borderColor: ORANGE,
              '&:hover': {
                bgcolor: ORANGE,
                color: DARK_BG,
            ...
            onClick={() => setView('assignmentStatus')}
          >
            Assignment Status
          </Button>
        </Grid>
